...
MODEL_PATH = os.path.join(ROOT_DIR, "weights", "resnet18_se.pth")
...
class SEBlock(nn.Module):
    ...
    This module recalibrates channel-wise feature responses:
    ...
    def __init__(self, channels, reduction=16):
        ...
        # Excitation network: learn channel importance
...
class EngagementModel(nn.Module):
    """
    ResNet18 with Squeeze-and-Excitation block for engagement detection.

    Architecture:
    - Pretrained ResNet18 backbone from ImageNet
    - SE block added after layer4 for channel attention
    - Dropout + linear classifier for binary classification
    """
    def __init__(self, num_classes=NUM_CLASSES):
        ...
        # Add SE block to final stage (layer4 has 512 channels)
...
if __name__ == "__main__":
    ...
    print("STARTING TRAINING - ResNet18 + SAE")
